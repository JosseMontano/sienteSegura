  ...
  return (
    <div className="container-formulario3">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="container-pregunta">
          <h3>¿Te amenaza con hacerte daño o dañar a tu familia si terminas la relación?</h3>
          <div className="container-respuestas">
            {vecLabel.map((v) => (
              <LabelComponent handleChange={() => handleChange(0, v.value)} v={v} />
            ))}
        ...
        <div className="container-pregunta">
          <h3>¿Te amenaza con hacerse daño o suicidarse si se acaba la relación?</h3>
          <div className="container-respuestas">
            {vecLabel.map((v) => (
              <LabelComponent handleChange={() => handleChange(0, v.value)} v={v} />
            ))}
        ...
        <div className="container-pregunta">
          <h3>¿Ha vuelto a agredirte después de haberte prometido que no lo volvería a hacer?</h3>
          <div className="container-respuestas">
            {vecLabel.map((v) => (
              <LabelComponent handleChange={() => handleChange(0, v.value)} v={v} />
            ))}
        ...
        <div className="container-pregunta">
          <h3>¿Estás deprimida y con problemas de salud, o has tenido pensamientos suicidas?</h3>
          <div className="container-respuestas">
            {vecLabel.map((v) => (
              <LabelComponent handleChange={() => handleChange(0, v.value)} v={v} />
            ))}
        ...
        <div className="container-pregunta">
          <h3>¿Las reacciones de violencia son impredecibles y más recurrentes?</h3>
          <div className="container-respuestas">
            {vecLabel.map((v) => (
              <LabelComponent handleChange={() => handleChange(0, v.value)} v={v} />
            ))}
        ...
        <div className="container-pregunta">
          <h3>¿Sientes que nadie te puede ayudar o no consideras que mereces ayuda?</h3>
          <div className="container-respuestas">
            {vecLabel.map((v) => (
              <LabelComponent handleChange={() => handleChange(0, v.value)} v={v} />
            ))}
        ...
        <div className="container-pregunta">
          <h3>¿Aunque temes por tu vida sientes que no hay cómo salir de la violencia?</h3>
          <div className="container-respuestas">
            {vecLabel.map((v) => (
              <LabelComponent handleChange={() => handleChange(0, v.value)} v={v} />
            ))}
